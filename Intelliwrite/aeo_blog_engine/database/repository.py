...
def create_blog_entry(
    ...
    *,
    ...
    entry = Blog(
        user_id=user_id,
        topic=[Blog.make_entry(topic, is_prompt=is_prompt)] if topic else [],
...
def update_blog_status(session, blog_id, *, status, blog_content=None, topic: Optional[str] = None, is_prompt: str = "false"):
